...
<tr>
	...
	<td> Returns a list of all the spouses for the player. </td>
</tr>
<tr>
...
<tr>
	...
	<td> Returns true if the player is currently dating or rooming with a monogamous npc, else false </td>
</tr>
</table>
